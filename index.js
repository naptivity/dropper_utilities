...
process.on("unhandledRejection", (reason, promise) => { //catches unhandled promise rejections
  console.log("--- An error occurred, please report this to lapisfloof/naptivity on Discord ---")
...
process.on("uncaughtException", (error, origin) => { //catches uncaught exceptions
  if (error.code !== "CUSTOM_NOLOG") {
    console.log("--- An exception occurred, please report this to lapisfloof/naptivity on Discord ---")
    console.error(error)
    console.log("--- An exception occurred, please report this to lapisfloof/naptivity on Discord ---")
  }
  try {
